  ...
  return (
    <div>
      ...
      <br />
            ...
            <FlippingCard frontImage={covid} name="Combating COVID_19" gitLink="https://github.com/Devanshi024/NoticeHUB" backContent="Proposed an IOT based attendance system with PHP for maintaining COVID safety guidelines.
            Selected for SSIP grant of 10,000." />
            <FlippingCard frontImage={booksell} name="Booksell"gitLink="https://github.com/Devanshi024/NoticeHUB"  backContent="ReactJS and Axios API- based Application for maintaining the bookstore." />
          </div>
    </div>
  )
}
